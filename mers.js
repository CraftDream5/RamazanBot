...
client.on('ready', () => {
  ...
  client.user.setActivity('Hoş geldin Ramazan d!yardım | Mer$ Bot', {type: "WATCHING"});
});
client.on('message', msg => {
  if (msg.content === prefix + 'iftar') {
  	if (msg.author.bot) return;
   	msg.reply('d!iftar [Şehir İsmi] | Şehirin baş harfi büyük olacak şekilde yazınız!');
  }
